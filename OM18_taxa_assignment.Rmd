---
title: "16S rRNA gene taxonomic assignment on DNA extracted from samples obtained in Oman in 2018"
subtitle: "Source file: OM18_taxa_assignment.Rmd"
...
```{r load-seqtab}
seqtab_nochim <- read_rds("data_output/seqtab_nochim_OM18_processed_20200719.rds")
```
...
# Export taxa table
```{r write-taxtab}
write_rds(taxa, path = format(Sys.Date(), "data_output/taxa_OM18_processed_%Y%m%d.rds"), compress = "gz")
```