---
title: "16S rRNA gene taxonomic assignment on DNA extracted from samples obtained in Oman in 2019 (re-sequence)"
subtitle: "Source file: OM19b_taxa_assignment.Rmd"
...
```{r load-seqtab}
seqtab_nochim <- read_rds("data_output/seqtab_nochim_OM19b_processed_20200929.rds")
```
...
# Export taxa table
```{r write-taxtab}
write_rds(taxa, path = format(Sys.Date(), "data_output/taxa_OM19b_processed_%Y%m%d.rds"), compress = "gz")
```