---
title: "16S rRNA gene taxonomic assignment on DNA extracted from samples obtained in Oman in 2014"
subtitle: "Source file: OM14_taxa_assignment.Rmd"
...
```{r load-seqtab}
seqtab_nochim <- read_rds("data_output/seqtab_nochim_OM14_processed_20200730.rds")
```
...
# Export taxa table
```{r write-taxtab}
write_rds(taxa, path = format(Sys.Date(), "data_output/taxa_OM14_processed_%Y%m%d.rds"), compress = "gz")
```