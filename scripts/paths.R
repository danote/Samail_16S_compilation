...
# map_path_OM17 <- file.path(data_path_OM17, "oman_map17S.txt")
# I1.fp <- file.path(data.fp, "Undetermined_S0_L001_I1_001.fastq.gz")
...
# Set file paths for barcodes file, map file, and fastqs
# barcode_path_OM19 <- "/Users/melo.d/Desktop/Research/Oman_fieldwork/2019/OM19_16S_processing/barcodes_OM19_anchored_5_prime.fasta"
# map_path_OM19 <- file.path(data_path_OM19, "oman_map19S.txt")
# I1.fp <- file.path(data.fp, "Undetermined_S0_L001_I1_001.fastq.gz")
# R1_path_OM19 <- "/Users/melo.d/Desktop/Research/Oman_fieldwork/2019/OM19_16S_processing/2019-Oman-16S-Amplicon-Data/emp-paired-end-sequences/forward.fastq.gz"
# R2_path_OM19 <- "/Users/melo.d/Desktop/Research/Oman_fieldwork/2019/OM19_16S_processing/2019-Oman-16S-Amplicon-Data/emp-paired-end-sequences/reverse.fastq.gz"
