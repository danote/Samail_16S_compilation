...
flags_cutadapt_1 <- paste("-e", error_rate_cutadapt, "--no-indels", "-m", minimum_length_cutadapt_1, "--overlap", minimum_overlap_cutadapt_1, "-g",  paste0("file:", barcode_path_OM17), "-o", file.path(demultiplex_assigned_path, "{name}_R1.fastq.gz"), "-p", file.path(demultiplex_assigned_path, "{name}_R2.fastq.gz"), "--untrimmed-output", file.path(demultiplex_unassigned_path, "unassigned_R1.fastq.gz"), "--untrimmed-paired-output", file.path(demultiplex_unassigned_path, "unassigned_R2.fastq.gz"), R1_path_OM17, R2_path_OM17)
...
```{r}
# cutadapt_messages_1 %>% paste(collapse = '\n') %>% cat(file="data_output/OM17_anchored_5_prime_cutadapt_demux_output.txt")
```
