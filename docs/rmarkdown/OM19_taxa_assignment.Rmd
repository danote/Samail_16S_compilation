...
---
---
title: "16S rRNA gene taxonomic assignment on DNA extracted from samples obtained in Oman in 2019"
subtitle: "Source file: OM19_taxa_assignment.Rmd"
...
```{r load-seqtab}
seqtab_nochim <- read_rds("data_output/seqtab_nochim_OM19_processed_20200715.rds")
```
...
# Export taxa table
```{r write-taxtab}
write_rds(taxa, path = format(Sys.Date(), "data_output/taxa_OM19_processed_%Y%m%d.rds"), compress = "gz")
```